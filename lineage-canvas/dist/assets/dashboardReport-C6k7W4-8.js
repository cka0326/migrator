import{a as e,i as t,n,r}from"./index-DAJAfXuN.js";import{n as i,t as a}from"./download-DAP42NLz.js";var o=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),s=e=>e?e.namespace?`${e.namespace}.${e.name}`:e.name:`∅ deleted`;function c(e,t,n){let r=2*Math.PI*42,i=r*(1-Math.max(0,Math.min(100,e))/100);return`<svg viewBox="0 0 110 110" width="120" height="120" role="img" aria-label="${o(t)} ${e}%">
